  ...
  return <section className="note-editor">
    <div className="note-editor-container">
      <form onSubmit={onSaveNote} className="note-form">
        <input onChange={handleChange} type="text" value={title} name="title" id="title" placeholder="Title" className="note-input note-title"/>
        <input onChange={handleChange} type="text" value={txt} name="txt" id="txt" placeholder="Take a note..." className="note-input note-text"/>
